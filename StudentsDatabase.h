// StudentsDatabase class defintion.
...
public:
	...
	void addCourseToStudent(const std::string&, const std::string&); // takes student user name and course's code; add course to student's coruses list
	Student* getStudent(const std::string&); // return pointer to student object
	void removeCourseFromStudent(const std::string&, const std::string&); // takes student's username and course's code; remove the course from the student's coruses list
